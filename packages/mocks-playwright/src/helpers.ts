import type { PlaywrightEnvVarValue, ArrayOfValues } from "./types";
...
export function valueIsOneOf(value: PlaywrightEnvVarValue, arrayOfValues: ArrayOfValues): boolean {
  return arrayOfValues.includes(value);
}

export function isFalsy(value: PlaywrightEnvVarValue) {
  return valueIsOneOf(value, FALSY_VALUES);
}

export function isTruthy(value: PlaywrightEnvVarValue) {
