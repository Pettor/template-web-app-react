    ...
    <DocumentationLayout label="Colors">
      <div className="flex flex-col">
        ...
        <div className="m-2 flex flex-1">
          ...
          <div className="flex flex-1 flex-row">
            <div className={"bg-primary flex basis-1/2 items-center p-6"} />
            <div className={"bg-primary-content flex basis-1/2 items-center p-6"} />
          </div>
        </div>
        <div className="m-2 flex flex-1">
          <div className="flex basis-1/4 items-center text-xl">Secondary</div>
          <div className="flex flex-1 flex-row">
            <div className={"bg-secondary flex basis-1/2 items-center p-6"} />
            <div className={"bg-secondary-content flex basis-1/2 items-center p-6"} />
          </div>
        </div>
        <div className="m-2 flex flex-1">
          <div className="flex basis-1/4 items-center text-xl">Accent</div>
          <div className="flex flex-1 flex-row">
            <div className={"bg-accent flex basis-1/2 items-center p-6"} />
            <div className={"bg-accent-content flex basis-1/2 items-center p-6"} />
          </div>
        </div>
        <div className="m-2 flex flex-1">
          <div className="flex basis-1/4 items-center text-xl">Neutral</div>
          <div className="flex flex-1 flex-row">
            <div className={"bg-neutral flex basis-1/2 items-center p-6"} />
            <div className={"bg-neutral-content flex basis-1/2 items-center p-6"} />
          </div>
        </div>
        <div className="m-2 flex flex-1">
          ...
          <div className="flex flex-1 flex-row">
            ...
            <div className={"bg-base-content flex basis-1/2 items-center p-6"} />
          </div>
        </div>
        <div className="m-2 flex flex-1">
          <div className="flex basis-1/4 items-center text-xl">Info</div>
          <div className="flex flex-1 flex-row">
            <div className={"bg-info flex basis-1/2 items-center p-6"} />
            <div className={"bg-info-content flex basis-1/2 items-center p-6"} />
          </div>
        </div>
        <div className="m-2 flex flex-1">
          <div className="flex basis-1/4 items-center text-xl">Success</div>
          <div className="flex flex-1 flex-row">
            <div className={"bg-success flex basis-1/2 items-center p-6"} />
            <div className={"bg-success-content flex basis-1/2 items-center p-6"} />
          </div>
        </div>
        <div className="m-2 flex flex-1">
          <div className="flex basis-1/4 items-center text-xl">Warning</div>
          <div className="flex flex-1 flex-row">
            <div className={"bg-warning flex basis-1/2 items-center p-6"} />
            <div className={"bg-warning-content flex basis-1/2 items-center p-6"} />
          </div>
        </div>
        <div className="m-2 flex flex-1">
          <div className="flex basis-1/4 items-center text-xl">Error</div>
          <div className="flex flex-1 flex-row">
            <div className={"bg-error flex basis-1/2 items-center p-6"} />
            <div className={"bg-error-content flex basis-1/2 items-center p-6"} />
          </div>
        </div>
      </div>
    </DocumentationLayout>
